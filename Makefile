...
ifndef AFL_TRACE_PC
	...
	if [ -f afl-driver-32.o ]; then set -e; install -m 755 afl-driver-32.o $${DESTDIR}$(HELPER_PATH); fi
	if [ -f afl-driver-64.o ]; then set -e; install -m 755 afl-driver-64.o $${DESTDIR}$(HELPER_PATH); fi
